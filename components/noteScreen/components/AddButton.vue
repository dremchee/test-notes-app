...
<template>
  <div class="add-button-container">
    <div class="add-button">
      <div class="dropbutton-box">
        <button class="dropdown-btn" @click="toggleDropDown"></button>
      </div>
      <div class="dropdown-container" v-show="isDropdownOpen">
        <div class="dropdown">
          <button class="select">
          ...
          <button class="select-document-padding select">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
...
svg path {
  fill: var(--color-almost-very-light-grey)
}
